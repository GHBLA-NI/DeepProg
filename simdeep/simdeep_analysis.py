...
class SimDeep(DeepBase):
    ...
    def compute_feature_scores(self, use_ref=False):
        ...
        for key in key_array:
            ...
            #print(f"check feature list and matrix: {feature_list} {matrix}")            
            labels = self.labels[:]
            ...
            #print("features_scored calculated")
    ...
    def _reduce_and_stack_matrices(self, matrices):
        ...
        if not self.nb_selected_features:
            ...
            print(f"Number of features selected: {self.nb_selected_features}")
            self.compute_feature_scores()
            print("compute_feature_scores function run successfully")
            matrix = []
